     ...
     {formattedDate && (
      ...
      <div className="note-actions">
        ...
        <button onClick={toggleChat}
            aria-label={showChat ? "Ukryj chat" : "Pokaż chat"} className={showChat ? "icon active" : "icon"}>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 1024 1024" fill={showChat ? "#0b7dda" : "#888"}>
